...
public enum Easing {
    ...
    final Function<Float, Number> function;

    Easing(Function<Float, Number> function) {
        this.function = function;
    }

    public Function<Float, Number> getFunction() {
        return function;
    }

    public static float apply(Easing easing, float value) {
        return easing.function.apply(value).floatValue();
    }
}
