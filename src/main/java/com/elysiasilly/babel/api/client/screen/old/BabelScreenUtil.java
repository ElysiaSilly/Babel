...
public class BabelScreenUtil {
    ...
    public static void fill(VertexConsumer consumer, Matrix4f matrix4f, Vector2d min, Vector2d max, float z, RGBA rgba) {
        consumer.addVertex(matrix4f, (float) min.x, (float) min.y, z).setColor(rgba.r(), rgba.g(), rgba.b(), rgba.a());
        consumer.addVertex(matrix4f, (float) min.x, (float) max.y, z).setColor(rgba.r(), rgba.g(), rgba.b(), rgba.a());
        consumer.addVertex(matrix4f, (float) max.x, (float) max.y, z).setColor(rgba.r(), rgba.g(), rgba.b(), rgba.a());
        consumer.addVertex(matrix4f, (float) max.x, (float) min.y, z).setColor(rgba.r(), rgba.g(), rgba.b(), rgba.a());
    }
