...
public abstract class BabelWidget<W extends BabelWidget, S extends BabelScreenOld> {
    ...
    public void unParent() {
        ...
        if(!this.screen.descendants.contains(this)) this.screen.descendants.add(this);
    }
