...
public class UtilsShader {
    ...
    public static RenderTarget depthBuffer() {
        return ((IRenderTargets) Minecraft.getInstance().levelRenderer).babel$getDepthRenderTarget();
    }

    public static RenderTarget mainBuffer() {
        return ((IRenderTargets) Minecraft.getInstance().levelRenderer).babel$getMainRenderTarget();
    }
}
